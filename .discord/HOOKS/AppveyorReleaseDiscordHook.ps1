...
$AVATAR="https://raw.githubusercontent.com/$env:APPVEYOR_REPO_NAME/$env:APPVEYOR_REPO_COMMIT/.discord/AVATARS/BrawlCrateAvatar.png"
...
if ($env:APPVEYOR_PULL_REQUEST_NUMBER) {
  ...
  $URL="https://github.com/$env:APPVEYOR_REPO_NAME/releases/tag/$env:APPVEYOR_REPO_TAG_NAME"
}
else {
  $URL=""
}
