...
namespace BrawlLib.Wii.Textures
{
    ...
    {
        private readonly bushort _data;
    ...
    public struct wRGBA6Pixel
    {
        ...
        {
            var val = (p._b1 << 16) | (p._b2 << 8) | p._b3;
            var r = val & 0xFC0000;
            r = (r >> 16) | (r >> 22);
            var g = val & 0x3F000;
            g = (g >> 10) | (g >> 16);
    ...
    public struct wRGB565Pixel
    {
        ...
        {
            var r = Math.Max(Math.Min(Convert.ToInt32(v._x * 31.0f), 31), 0);
            var g = Math.Max(Math.Min(Convert.ToInt32(v._y * 63.0f), 63), 0);
            var b = Math.Max(Math.Min(Convert.ToInt32(v._z * 31.0f), 31), 0);
