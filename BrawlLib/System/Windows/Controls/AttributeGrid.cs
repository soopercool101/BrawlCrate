...
namespace System.Windows.Forms
{
    public class AttributeGrid : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            dtgrdAttributes.Size = new Drawing.Size(479, 200);
            ...
            description.Size = new Drawing.Size(479, 74);
            ...
            splitter1.Location = new Drawing.Point(0, 200);
            ...
            panel1.Location = new Drawing.Point(0, 203);
            panel1.Name = "panel1";
            panel1.Size = new Drawing.Size(479, 102);
            panel1.TabIndex = 8;
            // 
            // btnInf
            // 
            ...
            btnInf.Location = new Drawing.Point(446, 44);
            btnInf.Name = "btnInf";
            btnInf.Size = new Drawing.Size(30, 30);
            btnInf.TabIndex = 13;
            btnInf.Text = "∞";
            ...
            btnMinusInf.Location = new Drawing.Point(412, 44);
            btnMinusInf.Name = "btnMinusInf";
            btnMinusInf.Size = new Drawing.Size(30, 30);
            ...
            lblColor.Location = new Drawing.Point(394, 60);
            ...
            lblCNoA.Location = new Drawing.Point(434, 60);
            ...
            tableLayoutPanel1.Location = new Drawing.Point(0, 77);
            tableLayoutPanel1.Name = "tableLayoutPanel1";
            tableLayoutPanel1.RowCount = 1;
            tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
            tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Absolute, 20F));
            tableLayoutPanel1.Size = new Drawing.Size(479, 25);
            ...
            rdoFloat.Size = new Drawing.Size(79, 25);
            rdoFloat.TabIndex = 0;
            ...
            rdoInt.Location = new Drawing.Point(79, 0);
            rdoInt.Margin = new Padding(0);
            rdoInt.Name = "rdoInt";
            rdoInt.Size = new Drawing.Size(79, 25);
            rdoInt.TabIndex = 1;
            rdoInt.TabStop = true;
            rdoInt.Text = "Integer";
            ...
            rdoColor.Location = new Drawing.Point(158, 0);
            rdoColor.Margin = new Padding(0);
            rdoColor.Name = "rdoColor";
            rdoColor.Size = new Drawing.Size(79, 25);
            rdoColor.TabIndex = 1;
            ...
            rdoFlags.Location = new Drawing.Point(237, 0);
            rdoFlags.Margin = new Padding(0);
            rdoFlags.Name = "rdoFlags";
            rdoFlags.Size = new Drawing.Size(79, 25);
            rdoFlags.TabIndex = 2;
            ...
            rdoDegrees.Location = new Drawing.Point(316, 0);
            rdoDegrees.Margin = new Padding(0);
            rdoDegrees.Name = "rdoDegrees";
            rdoDegrees.Size = new Drawing.Size(79, 25);
            ...
            rdoUnknown.Location = new Drawing.Point(395, 0);
            rdoUnknown.Margin = new Padding(0);
            rdoUnknown.Name = "rdoUnknown";
            rdoUnknown.Size = new Drawing.Size(84, 25);
        ...
        public void TargetChanged()
        {
            ...
            attributes.Rows.Clear();
            for (var i = 0; i < TargetNode.NumEntries; i++)
            ...
            for (var i = 0; i < TargetNode.NumEntries; i++) RefreshRow(i);
        ...
        private void dtgrdAttributes_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var index = dtgrdAttributes.CurrentCell.RowIndex;
            var value = attributes.Rows[index][1].ToString();

            var name = attributes.Rows[index][0].ToString();
            ...
            {
                var field0 = value.Replace(" ", string.Empty);
            ...
            else if (AttributeArray[index]._type == 4) // Hex
            {
                ...
                var fromBase = field0.StartsWith("0x", StringComparison.InvariantCultureIgnoreCase) ? 16 : 10;
                var temp = Convert.ToInt32(field0, fromBase);
                if (TargetNode.GetInt(index) != temp) TargetNode.SetInt(index, temp);
                if (fromBase == 10) AttributeArray[index]._type = 1;
            }
            ...
            if (AttributeArray[index]._type == 3) attributes.Rows[index][1] = TargetNode.GetRGBAPixel(index).ToString();
        ...
        {
            if (_updating || AttributeArray.Length == 0) return;
