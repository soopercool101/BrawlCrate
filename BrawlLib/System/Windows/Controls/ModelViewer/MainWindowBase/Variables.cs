...
namespace System.Windows.Forms
{
    public partial class ModelEditorBase : UserControl
    {
        ...
        public static readonly Type[] AnimTypeList =
        {
            typeof(CHR0Node),
            typeof(SRT0Node),
            typeof(SHP0Node),
        ...
        public Dictionary<string, Dictionary<int, List<int>>> VIS0Indices
        {
            get
            {
                if (_targetModel is MDL0Node) return ((MDL0Node) _targetModel).VIS0Indices;
