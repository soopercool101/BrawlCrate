    ...
    public partial class ModelEditorBase : UserControl
    {
        ...
        public CHR0Node SelectedCHR0
        {
            ...
            set
            {
                ...
                if (!_updating) AnimChanged(NW4RAnimType.CHR);
            }
        }
        ...
        public SRT0Node SelectedSRT0
        {
            ...
            set
            {
                ...
                if (!_updating) AnimChanged(NW4RAnimType.SRT);
            }
        }
        ...
        public SHP0Node SelectedSHP0
        {
            ...
            set
            {
                ...
                if (!_updating) AnimChanged(NW4RAnimType.SHP);
            }
        }
        ...
        public PAT0Node SelectedPAT0
        {
            ...
            set
            {
                ...
                if (!_updating) AnimChanged(NW4RAnimType.PAT);
            }
        }
        ...
        public VIS0Node SelectedVIS0
        {
            ...
            set
            {
                ...
                if (!_updating) AnimChanged(NW4RAnimType.VIS);
            }
        }
        ...
        public SCN0Node SelectedSCN0
        {
            ...
            set
            {
                ...
                if (!_updating) AnimChanged(NW4RAnimType.SCN);
            }
        }
        ...
        public CLR0Node SelectedCLR0
        {
            ...
            set
            {
                ...
                if (!_updating) AnimChanged(NW4RAnimType.CLR);
            }
        }
        ...
        public bool EnableTransformEdit
        {
            ...
            set
            {
                if (_enableTransform == value) return;

                _enableTransform = value;

                if (CHR0Editor != null) CHR0Editor.Enabled = value;

                if (SRT0Editor != null) SRT0Editor.Enabled = value;

                if (SHP0Editor != null) SHP0Editor.Enabled = value;

                if (VIS0Editor != null) VIS0Editor.Enabled = value;

                if (PAT0Editor != null) PAT0Editor.Enabled = value;

                if (SCN0Editor != null) SCN0Editor.Enabled = value;

                if (CLR0Editor != null) CLR0Editor.Enabled = value;

                if (KeyframePanel != null) KeyframePanel.Enabled = value;

                if (InterpolationEditor != null && InterpolationEditor.Visible) InterpolationEditor.Enabled = value;

                if (value) UpdatePropDisplay();
            }
        }
        ...
        public virtual NW4RAnimType TargetAnimType
        {
            ...
            set
            {
                if (_targetAnimType == value) return;
        ...
        public Vector3? VertexLoc
        {
            get
            {
                if (_selectedVertices == null || _selectedVertices.Count == 0) return null;

                if (_vertexLoc != null) return _vertexLoc;

                var average = new Vector3();
                foreach (var v in _selectedVertices) average += v.WeightedPosition;
            ...
            set
            {
                if (VertexLoc == null) return;

                if (value == null) return;

                if (_moveVerticesWithVertexLoc)
                {
                    var previous = VertexLoc.Value;
                    var diff = value.Value - previous;
                    foreach (var v in _selectedVertices) v.WeightedPosition += diff;
                }
        ...
        public virtual IBoneNode SelectedBone
        {
            ...
            set
            {
                if (_selectedBone != null) _selectedBone.BoneColor = _selectedBone.NodeColor = Color.Transparent;

                var boneSelected = (_selectedBone = value) != null;
                if (boneSelected)
                {
                ...
                if (BonesPanel != null) BonesPanel.SetSelectedBone(_selectedBone);
