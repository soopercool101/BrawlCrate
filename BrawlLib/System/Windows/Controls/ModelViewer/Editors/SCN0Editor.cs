...
namespace System.Windows.Forms
{
    public class SCN0Editor : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            LightSets.Location = new Drawing.Point(4, 25);
            LightSets.Name = "LightSets";
            LightSets.Padding = new Padding(3);
            LightSets.Size = new Drawing.Size(651, 97);
            ...
            AmbLights.Location = new Drawing.Point(4, 25);
            AmbLights.Name = "AmbLights";
            AmbLights.Padding = new Padding(3);
            AmbLights.Size = new Drawing.Size(651, 97);
            ...
            chkAmbAlpha.Location = new Drawing.Point(6, 24);
            chkAmbAlpha.Name = "chkAmbAlpha";
            chkAmbAlpha.Size = new Drawing.Size(95, 17);
            ...
            chkAmbClr.Location = new Drawing.Point(6, 6);
            chkAmbClr.Name = "chkAmbClr";
            chkAmbClr.Size = new Drawing.Size(92, 17);
            ...
            Lights.Location = new Drawing.Point(4, 25);
            Lights.Name = "Lights";
            Lights.Size = new Drawing.Size(651, 97);
            Lights.TabIndex = 2;
            Lights.Text = "Lights";
            ...
            // lightPaste
            // 
            lightPaste.Location = new Drawing.Point(104, 73);
            lightPaste.Name = "lightPaste";
            lightPaste.Size = new Drawing.Size(59, 20);
            ...
            // lightCopy
            // 
            lightCopy.Location = new Drawing.Point(46, 73);
            lightCopy.Name = "lightCopy";
            lightCopy.Size = new Drawing.Size(59, 20);
            ...
            // lightClear
            // 
            lightClear.Location = new Drawing.Point(220, 73);
            lightClear.Name = "lightClear";
            lightClear.Size = new Drawing.Size(59, 20);
            ...
            chkLightSpec.Location = new Drawing.Point(9, 76);
            chkLightSpec.Name = "chkLightSpec";
            chkLightSpec.Size = new Drawing.Size(110, 17);
            ...
            chkLightAlpha.Location = new Drawing.Point(9, 58);
            chkLightAlpha.Name = "chkLightAlpha";
            chkLightAlpha.Size = new Drawing.Size(95, 17);
            ...
            chkLightClr.Location = new Drawing.Point(9, 40);
            chkLightClr.Name = "chkLightClr";
            chkLightClr.Size = new Drawing.Size(92, 17);
            ...
            Fog.Location = new Drawing.Point(4, 25);
            Fog.Name = "Fog";
            Fog.Size = new Drawing.Size(651, 97);
            Fog.TabIndex = 3;
            Fog.Text = "Fog";
            ...
            // button3
            // 
            button3.Location = new Drawing.Point(311, 15);
            button3.Name = "button3";
            button3.Size = new Drawing.Size(59, 20);
            button3.TabIndex = 35;
            button3.Text = "Paste";
            ...
            // button4
            // 
            button4.Location = new Drawing.Point(253, 15);
            button4.Name = "button4";
            button4.Size = new Drawing.Size(59, 20);
            button4.TabIndex = 34;
            button4.Text = "Copy";
            ...
            Cameras.Location = new Drawing.Point(4, 25);
            Cameras.Name = "Cameras";
            Cameras.Size = new Drawing.Size(651, 97);
            Cameras.TabIndex = 4;
            ...
            // btnPaste
            // 
            btnPaste.Location = new Drawing.Point(440, 50);
            btnPaste.Name = "btnPaste";
            btnPaste.Size = new Drawing.Size(59, 20);
            ...
            // btnCopy
            // 
            btnCopy.Location = new Drawing.Point(382, 69);
            btnCopy.Name = "btnCopy";
            btnCopy.Size = new Drawing.Size(59, 20);
            btnCopy.TabIndex = 31;
            btnCopy.Text = "Copy";
            ...
            // btnClear
            // 
            btnClear.Location = new Drawing.Point(440, 69);
            btnClear.Name = "btnClear";
            btnClear.Size = new Drawing.Size(59, 20);
            ...
            // btnUseCamera
            // 
            btnUseCamera.Location = new Drawing.Point(3, 62);
            btnUseCamera.Name = "btnUseCamera";
            btnUseCamera.Size = new Drawing.Size(138, 23);
            ...
            groupBox1.Size = new Drawing.Size(147, 60);
            ...
            // btnRename
            // 
            btnRename.Location = new Drawing.Point(432, 0);
            btnRename.Name = "btnRename";
            btnRename.Size = new Drawing.Size(64, 23);
            ...
            // btnNew
            // 
            btnNew.Location = new Drawing.Point(496, 0);
            btnNew.Name = "btnNew";
            btnNew.Size = new Drawing.Size(45, 23);
            btnNew.TabIndex = 21;
            btnNew.Text = "New";
            ...
            // btnDelete
            // 
            btnDelete.Location = new Drawing.Point(541, 0);
            btnDelete.Name = "btnDelete";
            btnDelete.Size = new Drawing.Size(59, 23);
        ...
        public void UpdatePropDisplay()
        {
            ...
            for (var i = 0; i < (_tabIndex == 2 ? 10 : _tabIndex == 3 ? 2 : _tabIndex == 4 ? 15 : 0); i++) ResetBox(i);
        ...
        {
            var box = _transBoxes[_tabIndex - 2][index];

            if (SelectedAnimation != null && CurrentFrame >= 1 && Entry != null)
            {
                var array = Entry.KeyArrays[index];
                var kf = array.GetKeyframe(CurrentFrame - 1);
                if (kf == null)
                {
        ...
        private void nodeList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (btnRename.Enabled == false) btnRename.Enabled = true;
            ...
            switch (_tabIndex)
            {
                case 0:
                    ...
                    var amb = SelectedAnimation.GetFolder<SCN0AmbientLightNode>();

                    cboAmb.Items.Clear();
                    cboAmb.Items.Add("<null>");
                    if (amb != null) cboAmb.Items.AddRange(amb.Children.ToArray());

                    var lights = SelectedAnimation.GetFolder<SCN0LightNode>();
        ...
        private void UpdateNodeList()
        {
            ...
            {
                Enabled = true;
                foreach (SCN0EntryNode s in g.Children) cboNodeList.Items.Add(s);
            }
            else
            {
                Enabled = false;
        ...
        public void tabControl1_Selected(object sender, TabControlEventArgs e)
        {
            ...
            var s = SCN0GroupNode._names[_tabIndex];
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (cboNodeList.SelectedItem != null)
            {
                using (var d = new RenameDialog())
                {
                    d.ShowDialog(this, cboNodeList.SelectedItem as ResourceNode);
                }

                var i = cboNodeList.SelectedIndex;
                UpdateNodeList();
        ...
        {
            var panel = _mainWindow.ModelPanel;

            //Get the position of the current camera
            var camPos = panel.Camera.GetPoint();
            ...
            var rot = panel.Camera._rotation;
            ...
            else
            {
                ...
                if (SelectedAnimation != null && CurrentFrame >= 1 && Entry != null)
                {
                    var arr = Entry.KeyArrays[(int) numAimX.Tag];
                    var x = arr.GetFrameValue(CurrentFrame);

                    arr = Entry.KeyArrays[(int) numAimY.Tag];
                    var y = arr.GetFrameValue(CurrentFrame);

                    arr = Entry.KeyArrays[(int) numAimZ.Tag];
                    var z = arr.GetFrameValue(CurrentFrame);

                    var interpRefPoint = new Vector3(x, y, z);
                    var screenMidPt = new Vector2(panel.CurrentViewport.Region.Width / 2,
                        panel.CurrentViewport.Region.Height / 2);

                    var ray1 = panel.CurrentViewport.Camera.UnProject(screenMidPt._x, screenMidPt._y, 0.0f);
                    var ray2 = panel.CurrentViewport.Camera.UnProject(screenMidPt._x, screenMidPt._y, 1.0f);

                    var u = ray2 - ray1;
                    var pq = interpRefPoint - ray1;
                    var w2 = pq - u * (Vector3.Dot(pq, u) / u.Dot());

                    var point = interpRefPoint - w2;
        ...
        {
            var p = (ProjectionType) cboCamProj.SelectedIndex;
        ...
        private void lstCamType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (_camera != null)
            {
                ...
                var aim = _camera.Type == SCN0CameraType.Aim;
        ...
        {
            var t = (LightType) cboLightType.SelectedIndex;
            switch (t)
            {
        ...
        {
            var frame = new CameraAnimationFrame();
            var p = (float*) &frame;
        ...
        private unsafe void btnCopy_Click(object sender, EventArgs e)
        {
            ...
            for (var i = 0; i < 15; i++) p[i] = _transBoxes[2][i].Value;
        ...
        {
            var frame = _tempCameraFrame;
            var p = (float*) &frame;

            for (var i = 0; i < 15; i++)
            {
                if (_transBoxes[2][i].Value != p[i]) _transBoxes[2][i].Value = p[i];
        ...
        {
            var frame = new FogAnimationFrame();
            var p = (float*) &frame;

            for (var i = 0; i < 2; i++) p[i] = _transBoxes[1][i].Value;
        ...
        {
            var frame = _tempFogFrame;
            var p = (float*) &frame;

            for (var i = 0; i < 2; i++)
            {
                if (_transBoxes[1][i].Value != p[i]) _transBoxes[1][i].Value = p[i];
        ...
        {
            var frame = new LightAnimationFrame();
            var p = (float*) &frame;
        ...
        {
            var frame = _tempLightFrame;
            var p = (float*) &frame;

            for (var i = 0; i < 10; i++)
            {
                if (_transBoxes[0][i].Value != p[i]) _transBoxes[0][i].Value = p[i];
        ...
        private unsafe void lightCopy_Click(object sender, EventArgs e)
        {
            ...
            for (var i = 0; i < 10; i++) p[i] = _transBoxes[0][i].Value;
        ...
        public void UpdateInterpolationEditor(NumericInputBox box)
        {
            ...
            {
                var kfe = Entry.KeyArrays[(int) box.Tag].GetKeyframe(CurrentFrame - 1);
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            if (SelectedAnimation != null)
            {
                var x = SelectedAnimation.CreateResource((SCN0GroupNode.GroupType) _tabIndex, null);
                UpdateNodeList();
        ...
        {
            var x = cboNodeList.SelectedItem as SCN0EntryNode;
            x.Remove();
            UpdateNodeList();
        }
    }
