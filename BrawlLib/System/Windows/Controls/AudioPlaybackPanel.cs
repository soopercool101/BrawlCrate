...
namespace System.Windows.Forms
{
    public class AudioPlaybackPanel : UserControl
    {
        ...
        {
            InitializeComponent();
            VolumePercent = Settings.Default.AudioVolumePercent;
        ...
        public IAudioStream[] TargetStreams
        {
            ...
            set
            {
                if (value == _targetStreams) return;

                lstStreams.Items.Clear();
                if (_targetStreams != null)
                    for (var x = 0; x < _targetStreams.Length; x++)
                    {
                ...
                if ((_targetStreams = value) != null)
                {
                    ...
                    {
                        var i = 1;
                        foreach (var s in _targetStreams) lstStreams.Items.Add("Stream" + i++);
                    }
                    else
                    {
        ...
        ///     Custom Song Volume code's difference between 7F (max) and 3F seems to be 1/4 volume - about -6dB. In other words,
        ///     both the maximum and minimum amplitudes are halved.
        ...
        public int? Volume
        {
            ...
            {
                _volume = value;
                if (CurrentBuffer != null && _volume != null) CurrentBuffer.Volume = _volume.Value;
            }
        }
        ...
        public double? VolumePercent
        {
            set
            {
                ...
                Settings.Default.AudioVolumePercent = value;
                Settings.Default.Save();

                if (!_updating) trackBarVolume.Value = (int) (value * 100d + 0.5d);
            }
        }
        ...
        private AudioBuffer CurrentBuffer
        {
            get
            {
                if (_targetIndex < 0 || _buffers == null) return null;
        ...
        private void Close()
        {
            ...
            if (_targetStreams != null)
            {
                for (var i = 0; i < _targetStreams.Length; i++)
        ...
        private void TargetChanged(IAudioSource newTarget)
        {
            ...
            if ((TargetStreams = _targetSource.CreateStreams()) == null) return;
            ...
            if (_provider == null)
            {
                ...
                if (_provider != null) _provider.Attach(this);
            }
            ...
            if (_targetStream.Frequency > 0) UpdateTimeDisplay();
        ...
        private void UpdateTimeDisplay()
        {
            ...
            var t = new DateTime((long) trackBarPosition.Value * 10000000 / _targetStream.Frequency);
        ...
        private void Seek(int sample)
        {
            ...
            {
                Stop();
                if (CurrentBuffer != null) CurrentBuffer.Seek(sample);
        ...
        public void Play()
        {
            if (_isPlaying || CurrentBuffer == null) return;

            _isPlaying = true;

            //Start from beginning if at end
            if (trackBarPosition.Value == _targetStream.Samples) trackBarPosition.Value = 0;
        ...
        private void Stop()
        {
            ...
            //Stop device
            if (CurrentBuffer != null) CurrentBuffer.Stop();
        ...
        private void chkLoop_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (CurrentBuffer != null) CurrentBuffer.Loop = _loop;
        }
