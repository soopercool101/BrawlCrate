...
namespace System.Windows.Forms
{
    public partial class TexCoordControl : UserControl
    {
        ...
        {
            if (comboObj.Items.Count == 1) return;
        ...
        {
            if (comboUVs.Items.Count == 1) return;
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            var height = 512; //temporary - need to calculate width
            var width = 512; //temporary - need to calculate height
        ...
        {
            if (!_updating) texCoordRenderer1.SetObjectIndex(comboObj.SelectedIndex - 1);
        }

        private void comboUVs_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (!_updating) texCoordRenderer1.SetUVIndex(comboUVs.SelectedIndex - 1);
        }
    }
}