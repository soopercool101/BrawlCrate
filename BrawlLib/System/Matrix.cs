...
namespace System
{
    ...
    public unsafe struct Matrix : ISerializable
    {
        ...
        {
            for (var i = 0; i < 16; i++) Data[i] = info.GetSingle(string.Format("_values[{0}]", i));
        }

        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            for (var i = 0; i < 16; i++) info.AddValue(string.Format("_values[{0}]", i), Data[i]);
        }
        ...
        public Matrix(float* values)
        {
            var m = this;
            var p = (float*) &m;
            for (var i = 0; i < 16; i++) p[i] = values[i];
        }
        ...
        {
            return new Vector3(_values[0], _values[5], _values[10]);
        }
        ...
        {
            var cosx = (float) Math.Cos(x * Maths._deg2radf);
            var sinx = (float) Math.Sin(x * Maths._deg2radf);
            var cosy = (float) Math.Cos(y * Maths._deg2radf);
            var siny = (float) Math.Sin(y * Maths._deg2radf);
            var cosz = (float) Math.Cos(z * Maths._deg2radf);
            var sinz = (float) Math.Sin(z * Maths._deg2radf);
        ...
        {
            _values[12] += _values[0] * x + _values[4] * y + _values[8] * z;
            _values[13] += _values[1] * x + _values[5] * y + _values[9] * z;
            _values[14] += _values[2] * x + _values[6] * y + _values[10] * z;
            _values[15] += _values[3] * x + _values[7] * y + _values[11] * z;
        }

        public Vector3 Multiply(Vector3 v)
        {
            var nv = new Vector3();
            nv._x = _values[0] * v._x + _values[4] * v._y + _values[8] * v._z + _values[12];
            nv._y = _values[1] * v._x + _values[5] * v._y + _values[9] * v._z + _values[13];
            nv._z = _values[2] * v._x + _values[6] * v._y + _values[10] * v._z + _values[14];
            return nv;
        }
        ...
        {
            var nv = new Vector3();
            nv._x = _values[0] * v._x + _values[1] * v._y + _values[2] * v._z;
            nv._y = _values[4] * v._x + _values[5] * v._y + _values[6] * v._z;
            nv._z = _values[8] * v._x + _values[9] * v._y + _values[10] * v._z;
            return nv;
        }
        ...
        public static Vector4 operator *(Matrix m, Vector4 v)
        {
            ...
            for (var i = 0; i < 4; i++) dPtr[i] = p0[i] * v._x + p1[i] * v._y + p2[i] * v._z + p3[i] * v._w;
        ...
        {
            for (var i = 0; i < 16; i++) _values[i] *= p;
        }
        ...
        public static Matrix operator *(Matrix m1, Matrix m2)
        {
            ...
            {
                val = 0.0f;
                for (int x = b, y = a; y < 16; y += 4) val += s1[x++] * s2[y];
        ...
        {
            float var1, var2;
            var cosx = (float) Math.Cos(x / 180.0f * Math.PI);
            var sinx = (float) Math.Sin(x / 180.0f * Math.PI);

            var1 = _values[4];
            var2 = _values[8];
            _values[4] = var1 * cosx + var2 * sinx;
            _values[8] = var1 * -sinx + var2 * cosx;

            var1 = _values[5];
            var2 = _values[9];
            _values[5] = var1 * cosx + var2 * sinx;
            _values[9] = var1 * -sinx + var2 * cosx;

            var1 = _values[6];
            var2 = _values[10];
            _values[6] = var1 * cosx + var2 * sinx;
            _values[10] = var1 * -sinx + var2 * cosx;
        }

        public void RotateY(float y)
        {
            float var1, var2;
            var cosy = (float) Math.Cos(y / 180.0f * Math.PI);
            var siny = (float) Math.Sin(y / 180.0f * Math.PI);

            var1 = _values[0];
            var2 = _values[8];
            _values[0] = var1 * cosy + var2 * -siny;
            _values[8] = var1 * siny + var2 * cosy;

            var1 = _values[1];
            var2 = _values[9];
            _values[1] = var1 * cosy + var2 * -siny;
            _values[9] = var1 * siny + var2 * cosy;

            var1 = _values[2];
            var2 = _values[10];
            _values[2] = var1 * cosy + var2 * -siny;
            _values[10] = var1 * siny + var2 * cosy;
        }

        public void RotateZ(float z)
        {
            float var1, var2;
            var cosz = (float) Math.Cos(z / 180.0f * Math.PI);
            var sinz = (float) Math.Sin(z / 180.0f * Math.PI);

            var1 = _values[0];
            var2 = _values[4];
            _values[0] = var1 * cosz + var2 * sinz;
            _values[4] = var1 * -sinz + var2 * cosz;

            var1 = _values[1];
            var2 = _values[5];
            _values[1] = var1 * cosz + var2 * sinz;
            _values[5] = var1 * -sinz + var2 * cosz;

            var1 = _values[2];
            var2 = _values[6];
            _values[2] = var1 * cosz + var2 * sinz;
            _values[6] = var1 * -sinz + var2 * cosz;
        }
        ...
        public Vector4 GetQuaternion2()
        {
            ...
            else
            {
                if (p[0] > p[5] && p[0] > p[10])
                {
                    var s = 2.0 * Math.Sqrt(1.0 + p[0] - p[5] - p[10]);
                    q[0] = (float) (0.25 * s);
                    q[1] = (float) ((p[1] + p[4]) / s);
                    q[2] = (float) ((p[2] + p[8]) / s);
                    q[3] = (float) ((p[6] - p[9]) / s);
                ...
                {
                    var s = 2.0 * Math.Sqrt(1.0 + p[5] - p[0] - p[10]);
                    q[0] = (float) ((p[1] + p[4]) / s);
                    q[1] = (float) (0.25 * s);
                    q[2] = (float) ((p[6] + p[9]) / s);
                    q[3] = (float) ((p[2] - p[8]) / s);
                ...
                {
                    var s = 2.0 * Math.Sqrt(1.0 + p[10] - p[0] - p[5]);
                    q[0] = (float) ((p[2] + p[8]) / s);
                    q[1] = (float) ((p[6] + p[9]) / s);
                    q[2] = (float) (0.25 * s);
                    q[3] = (float) ((p[1] - p[4]) / s);
        ...
        public Vector3 GetAngles()
        {
            ...
            {
                c = (float) Math.Cos(y);
                x = (float) Math.Atan2(_values[6] / c, _values[10] / c);
                z = (float) Math.Atan2(_values[1] / c, _values[0] / c);
        ...
        public FrameState Derive()
        {
            ...
            //Translation is easy!
            state._translate = *(Vector3*) &_values[12];

            //Scale, use sqrt of rotation columns
            state._scale._x =
                (float) Math.Round(
                    Math.Sqrt(_values[0] * _values[0] + _values[1] * _values[1] + _values[2] * _values[2]), 4);
            state._scale._y =
                (float) Math.Round(
                    Math.Sqrt(_values[4] * _values[4] + _values[5] * _values[5] + _values[6] * _values[6]), 4);
            state._scale._z =
                (float) Math.Round(
                    Math.Sqrt(_values[8] * _values[8] + _values[9] * _values[9] + _values[10] * _values[10]), 4);
        ...
        public static Matrix PerspectiveMatrix(float fovY, float aspect, float nearZ, float farZ)
        {
            ...
            var cotan = (float) (1.0 / Math.Tan(fovY / 2 * Math.PI / 180.0));
        ...
        public static Matrix ReversePerspectiveMatrix(float fovY, float aspect, float nearZ, float farZ)
        {
            ...
            var cotan = (float) (1.0 / Math.Tan(fovY / 2 * Math.PI / 180.0));
            var val = 2.0f * farZ * nearZ / (nearZ - farZ);
        ...
        public static Matrix TransformMatrix(Vector3 scale, Vector3 rotate, Vector3 translate)
        {
            ...
            var cosx = (float) Math.Cos(rotate._x * Maths._deg2radf);
            var sinx = (float) Math.Sin(rotate._x * Maths._deg2radf);
            var cosy = (float) Math.Cos(rotate._y * Maths._deg2radf);
            var siny = (float) Math.Sin(rotate._y * Maths._deg2radf);
            var cosz = (float) Math.Cos(rotate._z * Maths._deg2radf);
            var sinz = (float) Math.Sin(rotate._z * Maths._deg2radf);
        ...
        {
            var cosx = (float) Math.Cos(rotation._x * Maths._deg2radf);
            var sinx = (float) Math.Sin(rotation._x * Maths._deg2radf);
            var cosy = (float) Math.Cos(rotation._y * Maths._deg2radf);
            var siny = (float) Math.Sin(rotation._y * Maths._deg2radf);
            var cosz = (float) Math.Cos(rotation._z * Maths._deg2radf);
            var sinz = (float) Math.Sin(rotation._z * Maths._deg2radf);
        ...
        public static Matrix QuaternionTransformMatrix(Vector3 scale, Vector4 rotate, Vector3 translate)
        {
            ...
            var xx = rotate._x * rotate._x;
            var yy = rotate._y * rotate._y;
            var zz = rotate._z * rotate._z;
            var xy = rotate._x * rotate._y;
            var zw = rotate._z * rotate._w;
            var zx = rotate._z * rotate._x;
            var yw = rotate._y * rotate._w;
            var yz = rotate._y * rotate._z;
            var xw = rotate._x * rotate._w;
        ...
        public static Matrix AxisAngleMatrix(Vector3 point1, Vector3 point2)
        {
            ...
            if (point1 != point2)
            {
                ...
                var vSin = point1.Cross(point2);
                var axis = vSin.Normalize();

                var cos = point1.Dot(point2);
                var vt = axis * (1.0f - cos);
        ...
        {
            var up = new Vector3(-(float) Math.Sin(roll * Maths._deg2radf), (float) Math.Cos(roll * Maths._deg2radf),
                0);
        ...
        public static Matrix ReverseLookat(Vector3 eye, Vector3 target, float roll)
        {
            ...
            var xaxis = up.Cross(zaxis).Normalize();
            var yaxis = xaxis.Cross(zaxis).Normalize();
        ...
        {
            if (obj is Matrix) return (Matrix) obj == this;
