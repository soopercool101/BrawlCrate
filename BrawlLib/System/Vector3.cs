    ...
    public unsafe struct Vector3 : IComparable, ISerializable
    {
        ...
        public static bool Contained(Vector3 point, Vector3 start, Vector3 end, float expansion)
        {
            ...
            for (var i = 0; i < 3; i++)
            {
                ...
                if (sPtr[i] < s1[i] - expansion || sPtr[i] > s2[i] + expansion) return false;
            }
        ...
        {
            var a = ray2._z - ray1._z;

            var tanX = (ray1._y - ray2._y) / a;
            var tanY = (ray2._x - ray1._x) / a;
        ...
        {
            if (obj is Vector3) return this == (Vector3) obj;
        ...
        {
            var v0 = triPt2 - triPt1;
            var v1 = triPt3 - triPt1;
            var v2 = this - triPt1;
