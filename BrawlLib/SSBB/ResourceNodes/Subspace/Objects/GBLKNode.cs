...
namespace BrawlLib.SSBB.ResourceNodes
{
    ...
    public unsafe class GBLKEntryNode : ResourceNode
    {
        ...
        [Category("Flags")]
        public byte Flag1 => *(byte*)(Header + 0x24);
        [Category("Flags")]
        public byte Flag2 => *(byte*)(Header + 0x25);
        [Category("Flags")]
        public byte Flag3 => *(byte*)(Header + 0x26);
        [Category("Flags")]
        public byte Flag4 => *(byte*)(Header + 0x27);

        [Category("Misc")]
        public int unk0 => *(byte*)(WorkingUncompressed.Address + 0x28);
        [Category("Misc")]
        public bfloat unk1 => *(bfloat*)(WorkingUncompressed.Address + 0x04);
        [Category("Misc")]
        public bfloat unk2 => *(bfloat*)(WorkingUncompressed.Address + 0x10);
        [Category("Misc")]
        public byte unk3 => *(byte*)(WorkingUncompressed.Address + 0x23);
