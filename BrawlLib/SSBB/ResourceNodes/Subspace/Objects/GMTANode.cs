...
{
    public class GMTANode : BLOCEntryNode
    {
        public override Type SubEntryType => typeof(GMTAEntryNode);
        protected override string baseName => "Motion Attack Ground";

        internal static ResourceNode TryParse(DataSource source, ResourceNode parent)
        {
            return source.Tag == "GMTA" ? new GMTANode() : null;
        }
    }

    public unsafe class GMTAEntryNode : ResourceNode
    {
        protected internal GMTAEntry Data;
        ...
        [DisplayName("Unknown0x22D (bool)")]
        [Category("Unknown")]
        public bool Unknown0x22D
        {
        ...
        {
            return GMTAEntry.Size;
        }

        public override bool OnInitialize()
        {
            Data = *(GMTAEntry*) WorkingUncompressed.Address;
        ...
        {
            GMTAEntry* hdr = (GMTAEntry*)address;
