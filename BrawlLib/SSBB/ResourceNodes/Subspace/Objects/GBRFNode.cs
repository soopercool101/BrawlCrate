...
{
    public class GBRFNode : BLOCEntryNode
    {
        public override Type SubEntryType => typeof(GBRFEntryNode);
        protected override string baseName => "Breakable Floors";

        internal static ResourceNode TryParse(DataSource source, ResourceNode parent)
        {
            return source.Tag == "GBRF" ? new GBRFNode() : null;
        }
    }

    public unsafe class GBRFEntryNode : ResourceNode
    {
        protected internal GBRFEntry Data;

        [DisplayName("Unknown0x000 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x000
        {
        ...
        [DisplayName("Unknown0x001 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x001
        {
            get => Data._unknown0x001;
            set
            {
                Data._unknown0x001 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x002 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x002
        {
            get => Data._unknown0x002;
            set
            {
                Data._unknown0x002 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x003 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x003
        {
            get => Data._unknown0x003;
            set
            {
                Data._unknown0x003 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x004 (int)")]
        [Category("Unknown")]
        public int Unknown0x004
        {
        ...
        [DisplayName("Unknown0x010 (int)")]
        [Category("Unknown")]
        public int Unknown0x010
        {
        ...
        [DisplayName("Unknown0x01C (int)")]
        [Category("Unknown")]
        public int Unknown0x01C
        {
        ...
        [DisplayName("Unknown0x028 (uint)")]
        [Category("Unknown")]
        public uint Unknown0x028
        {
        ...
        [DisplayName("Unknown0x034 (uint)")]
        [Category("Unknown")]
        public uint Unknown0x034
        {
        ...
        [DisplayName("Unknown0x118 (short)")]
        [Category("Unknown")]
        public short Unknown0x118
        {
        ...
        [DisplayName("Unknown0x11A (short)")]
        [Category("Unknown")]
        public short Unknown0x11A
        {
        ...
        [DisplayName("Unknown0x11C (short)")]
        [Category("Unknown")]
        public short Unknown0x11C
        {
        ...
        [DisplayName("Unknown0x11E (short)")]
        [Category("Unknown")]
        public short Unknown0x11E
        {
            get => Data._unknown0x11E;
            set
            {
                Data._unknown0x11E = value;
                SignalPropertyChange();
            }
        }
        ...
        public TriggerDataClass _unknown0x19C;
        [TypeConverter(typeof(ExpandableObjectCustomConverter))]
        [DisplayName("Unknown0x19C (TriggerData)")]
        [Category("Unknown")]
        public TriggerDataClass Unknown0x19C
        {
            get => _unknown0x19C ?? new TriggerDataClass(this);
            set
            {
                _unknown0x19C = value;
        ...
        public TriggerDataClass _unknown0x1A0;
        [TypeConverter(typeof(ExpandableObjectCustomConverter))]
        [DisplayName("Unknown0x1A0 (TriggerData)")]
        [Category("Unknown")]
        public TriggerDataClass Unknown0x1A0
        {
            get => _unknown0x1A0 ?? new TriggerDataClass(this);
            set
            {
                _unknown0x1A0 = value;
        ...
        {
            return GBRFEntry.Size;
        }

        public override bool OnInitialize()
        {
            Data = *(GBRFEntry*) WorkingUncompressed.Address;
            _unknown0x19C = new TriggerDataClass(this, Data._unknown0x19C);
            _unknown0x1A0 = new TriggerDataClass(this, Data._unknown0x1A0);

            if (_name == null)
            {
                _name = $"Breakable Floor [{Index}]";
            }
        ...
        {
            GBRFEntry* hdr = (GBRFEntry*)address;
            Data._unknown0x19C = _unknown0x19C;
            Data._unknown0x1A0 = _unknown0x1A0;
            *hdr = Data;
        }
    }
}