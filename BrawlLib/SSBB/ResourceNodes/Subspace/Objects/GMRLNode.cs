...
{
    public class GMRLNode : BLOCEntryNode
    {
        public override Type SubEntryType => typeof(GMRLEntryNode);
        protected override string baseName => "Ring Lifts";

        internal static ResourceNode TryParse(DataSource source, ResourceNode parent)
        {
            return source.Tag == "GMRL" ? new GMRLNode() : null;
        }
    }

    public unsafe class GMRLEntryNode : ResourceNode
    {
        protected internal GMRLEntry Data;
        ...
        [DisplayName("Unknown0x1F0 (bool)")]
        [Category("Unknown")]
        public bool Unknown0x1F0
        {
        ...
        [DisplayName("Unknown0x1F1 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x1F1
        {
            get => Data._unknown0x1F1;
            set
            {
                Data._unknown0x1F1 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x1F2 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x1F2
        {
            get => Data._unknown0x1F2;
            set
            {
                Data._unknown0x1F2 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x1F3 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x1F3
        {
            get => Data._unknown0x1F3;
            set
            {
                Data._unknown0x1F3 = value;
                SignalPropertyChange();
            }
        }
        ...
        {
            return GMRLEntry.Size;
        }

        public override bool OnInitialize()
        {
            Data = *(GMRLEntry*) WorkingUncompressed.Address;
        ...
        {
            GMRLEntry* hdr = (GMRLEntry*)address;
