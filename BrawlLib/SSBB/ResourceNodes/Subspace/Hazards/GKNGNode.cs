...
{
    public class GKNGNode : BLOCEntryNode
    {
        public override Type SubEntryType => typeof(GKNGEntryNode);
        protected override string baseName => "Porky Statues";

        internal static ResourceNode TryParse(DataSource source, ResourceNode parent)
        {
            return source.Tag == "GKNG" ? new GKNGNode() : null;
        }
    }

    public unsafe class GKNGEntryNode : ResourceNode
    {
        ...
        [DisplayName("Unknown0x044 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x044
        {
        ...
        [DisplayName("Unknown0x045 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x045
        {
            get => Data._unknown0x045;
            set
            {
                Data._unknown0x045 = value;
                SignalPropertyChange();
            }
        }
        ...
        [DisplayName("Unknown0x234 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x234
        {
        ...
        [DisplayName("Unknown0x235 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x235
        {
            get => Data._unknown0x235;
            set
            {
                Data._unknown0x235 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x236 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x236
        {
            get => Data._unknown0x236;
            set
            {
                Data._unknown0x236 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x237 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x237
        {
            get => Data._unknown0x237;
            set
            {
                Data._unknown0x237 = value;
                SignalPropertyChange();
            }
        }
        ...
        [DisplayName("Unknown0x240 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x240
        {
        ...
        [DisplayName("Unknown0x241 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x241
        {
            get => Data._unknown0x241;
            set
            {
                Data._unknown0x241 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x242 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x242
        {
            get => Data._unknown0x242;
            set
            {
                Data._unknown0x242 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x243 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x243
        {
            get => Data._unknown0x243;
            set
            {
                Data._unknown0x243 = value;
                SignalPropertyChange();
            }
        }
        ...
        [DisplayName("Unknown0x248 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x248
        {
        ...
        [DisplayName("Unknown0x249 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x249
        {
            get => Data._unknown0x249;
            set
            {
                Data._unknown0x249 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x24A (byte)")]
        [Category("Unknown")]
        public byte Unknown0x24A
        {
            get => Data._unknown0x24A;
            set
            {
                Data._unknown0x24A = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x24B (byte)")]
        [Category("Unknown")]
        public byte Unknown0x24B
        {
            get => Data._unknown0x24B;
            set
            {
                Data._unknown0x24B = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x24C (byte)")]
        [Category("Unknown")]
        public byte Unknown0x24C
        {
        ...
        [DisplayName("Unknown0x24D (byte)")]
        [Category("Unknown")]
        public byte Unknown0x24D
        {
            get => Data._unknown0x24D;
            set
            {
                Data._unknown0x24D = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x24E (byte)")]
        [Category("Unknown")]
        public byte Unknown0x24E
        {
            get => Data._unknown0x24E;
            set
            {
                Data._unknown0x24E = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x24F (byte)")]
        [Category("Unknown")]
        public byte Unknown0x24F
        {
            get => Data._unknown0x24F;
            set
            {
                Data._unknown0x24F = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x250 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x250
        {
        ...
        [DisplayName("Unknown0x251 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x251
        {
            get => Data._unknown0x251;
            set
            {
                Data._unknown0x251 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x252 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x252
        {
            get => Data._unknown0x252;
            set
            {
                Data._unknown0x252 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x253 (byte)")]
        [Category("Unknown")]
        public byte Unknown0x253
        {
            get => Data._unknown0x253;
            set
            {
                Data._unknown0x253 = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x254 (short)")]
        [Category("Unknown")]
        public short Unknown0x254
        {
        ...
        [DisplayName("Unknown0x256 (short)")]
        [Category("Unknown")]
        public short Unknown0x256
        {
            get => Data._unknown0x256;
            set
            {
                Data._unknown0x256 = value;
                SignalPropertyChange();
            }
        }
