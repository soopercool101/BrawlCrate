...
{
    public class GFRKNode : BLOCEntryNode
    {
        public override Type SubEntryType => typeof(GFRKEntryNode);
        protected override string baseName => "Falling Rocks";

        internal static ResourceNode TryParse(DataSource source, ResourceNode parent)
        {
            return source.Tag == "GFRK" ? new GFRKNode() : null;
        }
    }

    public unsafe class GFRKEntryNode : ResourceNode
    {
        protected internal GFRKEntry Data;
        ...
        [DisplayName("Unknown0x1BC (short)")]
        [Category("Unknown")]
        public short Unknown0x1BC
        {
        ...
        [DisplayName("Unknown0x1BE (short)")]
        [Category("Unknown")]
        public short Unknown0x1BE
        {
        ...
        [DisplayName("Unknown0x1C4 (short)")]
        [Category("Unknown")]
        public short Unknown0x1C4
        {
        ...
        [DisplayName("Unknown0x1C6 (short)")]
        [Category("Unknown")]
        public short Unknown0x1C6
        {
            get => Data._unknown0x1C6;
            set
            {
                Data._unknown0x1C6 = value;
                SignalPropertyChange();
            }
        }
        ...
        [DisplayName("Unknown0x23C (byte)")]
        [Category("Unknown")]
        public byte Unknown0x23C
        {
        ...
        [DisplayName("Unknown0x23D (byte)")]
        [Category("Unknown")]
        public byte Unknown0x23D
        {
            get => Data._unknown0x23D;
            set
            {
                Data._unknown0x23D = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x23E (byte)")]
        [Category("Unknown")]
        public byte Unknown0x23E
        {
            get => Data._unknown0x23E;
            set
            {
                Data._unknown0x23E = value;
                SignalPropertyChange();
            }
        }

        [DisplayName("Unknown0x23F (bool)")]
        [Category("Unknown")]
        public bool Unknown0x23F
        {
            get => Data._unknown0x23F;
            set
            {
                Data._unknown0x23F = value;
                SignalPropertyChange();
            }
        }
        ...
        [DisplayName("Unknown0x24C (float)")]
        [Category("Unknown")]
        public float Unknown0x24C
        {
        ...
        [DisplayName("Unknown0x258 (float)")]
        [Category("Unknown")]
        public float Unknown0x258
        {
        ...
        [DisplayName("Unknown0x260 (float)")]
        [Category("Unknown")]
        public float Unknown0x260
        {
        ...
        [DisplayName("Unknown0x284 (short)")]
        [Category("Unknown")]
        public short Unknown0x284
        {
        ...
        [DisplayName("Unknown0x286 (short)")]
        [Category("Unknown")]
        public short Unknown0x286
        {
            get => Data._unknown0x286;
            set
            {
                Data._unknown0x286 = value;
                SignalPropertyChange();
            }
        }
        ...
        {
            GFRKEntry* hdr = (GFRKEntry*)address;
