...
{
    public class GMCANode : BLOCEntryNode
    {
        public override Type SubEntryType => typeof(GMCAEntryNode);
        protected override string baseName => "Move Circle Attack Ground";

        internal static ResourceNode TryParse(DataSource source, ResourceNode parent)
        {
            return source.Tag == "GMCA" ? new GMCANode() : null;
        }
    }

    public unsafe class GMCAEntryNode : ResourceNode
    {
        protected internal GMCAEntry Data;
        ...
        [DisplayName("Unknown0x22F (bool)")]
        [Category("Unknown")]
        public bool Unknown0x22F
        {
        ...
        [DisplayName("Unknown0x248 (short)")]
        [Category("Unknown")]
        public short Unknown0x248
        {
        ...
        [DisplayName("Unknown0x24A (short)")]
        [Category("Unknown")]
        public short Unknown0x24A
        {
        ...
        {
            return GMCAEntry.Size;
        }

        public override bool OnInitialize()
        {
            Data = *(GMCAEntry*) WorkingUncompressed.Address;
        ...
        {
            GMCAEntry* hdr = (GMCAEntry*)address;
