...
{
    public class GMEANode : BLOCEntryNode
    {
        public override Type SubEntryType => typeof(GMEAEntryNode);
        protected override string baseName => "Move Effect Attack Ground";

        internal static ResourceNode TryParse(DataSource source, ResourceNode parent)
        {
            return source.Tag == "GMEA" ? new GMEANode() : null;
        }
    }

    public unsafe class GMEAEntryNode : ResourceNode
    {
        protected internal GMEAEntry Data;
        ...
        {
            return GMEAEntry.Size;
        }

        public override bool OnInitialize()
        {
            Data = *(GMEAEntry*) WorkingUncompressed.Address;
        ...
        {
            GMEAEntry* hdr = (GMEAEntry*)address;
