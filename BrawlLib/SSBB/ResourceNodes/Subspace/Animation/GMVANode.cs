...
{
    public class GMVANode : BLOCEntryNode
    {
        public override Type SubEntryType => typeof(GMVAEntryNode);
        protected override string baseName => "Move Attack Ground";

        internal static ResourceNode TryParse(DataSource source, ResourceNode parent)
        {
            return source.Tag == "GMVA" ? new GMVANode() : null;
        }
    }

    public unsafe class GMVAEntryNode : ResourceNode
    {
        protected internal GMVAEntry Data;
        ...
        public DifficultyRatiosClass _difficultyMotionRatio;
        [TypeConverter(typeof(ExpandableObjectCustomConverter))]
        [Category("GMVA")]
        public DifficultyRatiosClass DifficultyMotionRatio
        {
            get => _difficultyMotionRatio ?? new DifficultyRatiosClass(this);
            set
            {
                _difficultyMotionRatio = value;
                Data._difficultyMotionRatio = value;
                SignalPropertyChange();
            }
        }
        ...
        [DisplayName("Unknown0x06C (short)")]
        [Category("Unknown")]
        public short Unknown0x06C
        {
        ...
        [DisplayName("Unknown0x06E (short)")]
        [Category("Unknown")]
        public short Unknown0x06E
        {
            get => Data._unknown0x06E;
            set
            {
                Data._unknown0x06E = value;
                SignalPropertyChange();
            }
        }
        ...
        [DisplayName("Unknown0x15C (short)")]
        [Category("Unknown")]
        public short Unknown0x15C
        {
        ...
        [DisplayName("Unknown0x15E (short)")]
        [Category("Unknown")]
        public short Unknown0x15E
        {
        ...
        [DisplayName("Unknown0x168 (short)")]
        [Category("Unknown")]
        public short Unknown0x168
        {
        ...
        [DisplayName("Unknown0x16A (short)")]
        [Category("Unknown")]
        public short Unknown0x16A
        {
        ...
        [DisplayName("Unknown0x174 (short)")]
        [Category("Unknown")]
        public short Unknown0x174
        {
        ...
        [DisplayName("Unknown0x176 (short)")]
        [Category("Unknown")]
        public short Unknown0x176
        {
        ...
        [DisplayName("Unknown0x214 (short)")]
        [Category("Unknown")]
        public short Unknown0x214
        {
        ...
        [DisplayName("Unknown0x216 (short)")]
        [Category("Unknown")]
        public short Unknown0x216
        {
            get => Data._unknown0x216;
            set
            {
                Data._unknown0x216 = value;
                SignalPropertyChange();
            }
        }
        ...
        [DisplayName("Unknown0x235 (bool)")]
        [Category("Unknown")]
        public bool Unknown0x235
        {
        ...
        {
            return GMVAEntry.Size;
        }

        public override bool OnInitialize()
        {
            Data = *(GMVAEntry*) WorkingUncompressed.Address;
            _motionPath = new MotionPathDataClass(this, Data._motionPath);
            _difficultyMotionRatio = new DifficultyRatiosClass(this, Data._difficultyMotionRatio);
        ...
        {
            GMVAEntry* hdr = (GMVAEntry*)address;
            Data._motionPath = _motionPath;
            Data._difficultyMotionRatio = _difficultyMotionRatio;
