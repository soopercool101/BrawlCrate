...
namespace BrawlLib.SSBB.ResourceNodes
{
    public unsafe class MDL0NormalNode : MDL0EntryNode
    {
        ...
        public bool ForceFloat
        {
            ...
            set
            {
                if (_forceFloat != value) _forceFloat = value;
            }
        }
        ...
        public Vector3[] Normals
        {
            ...
            set
            {
                ...
                _forceRebuild = true;
                if (Format == WiiVertexComponentType.Float) _forceFloat = true;
        ...
        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            if (Model._isImport || _forceRebuild)
            {
                var header = (MDL0NormalData*) address;
        ...
        {
            var header = (MDL0NormalData*) dataAddress;
