...
namespace BrawlLib.SSBB.ResourceNodes
{
    public unsafe class AIPDNode : ARCEntryNode
    {
        ...
        {
            if (_name == null || _name == "") _name = "AIPD_" + Parent.Name.Replace("ai_", "");
        ...
        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            ...
            foreach (var n in Children)
            {
                ...
                if (n is AIPDType2OffsetsNode) ((AIPDType2OffsetsNode) n).Type1EntrySize = type1EntrySize;
    ...
    public unsafe class AIPDDefBlockNode : ResourceNode
    {
        ...
        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            var header = (AIPDDefBlock*) address;
    ...
    public unsafe class AIPDSubBlockNode : ResourceNode
    {
        ...
        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            var header = (AIPDSubBlock*) address;
    ...
    public unsafe class AIPDUnkBlockNode : ResourceNode
    {
        ...
        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            for (var i = 0; i < padding.Length; i++) ((byte*) address)[i] = padding[i];
        }
    ...
    public unsafe class AIPDType1OffsetsNode : ResourceNode
    {
        ...
        public override void OnPopulate()
        {
            foreach (var ptr in Entries) new AIPDType1Node().Initialize(this, new DataSource(ptr, 0x0));
        }

        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            var Offsets = (bint*) address;
            var offset = Type2OffsetSize + 0x70 + 0x170;
            var entry = address + offset - 0x170;
            var childSize = 0;
            for (var i = 0; i < Children.Count; i++)
            {
                if (Children[i].Name != "NULL") Offsets[i] = offset; //set offset
        ...
        {
            var size = 0;
            foreach (AIPDType1Node n in Children) size += n.CalculateSize(true);
    ...
    public unsafe class AIPDType1Node : ResourceNode
    {
        ...
        public override bool OnInitialize()
        {
            ...
            {
                if (_name == null) _name = "Entry" + Parent.Children.IndexOf(this);
        ...
        public override void OnPopulate()
        {
            foreach (var ptr in Entries) new AIPDType1EntryNode().Initialize(this, new DataSource(ptr, 0x3));
        }
        ...
        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            ...
            if (_name != "NULL") *(byte*) address = 0x0;
        }

        public override int OnCalculateSize(bool force)
        {
            var size = 0;
            foreach (AIPDType1EntryNode n in Children) size += n.CalculateSize(true);
    ...
    public unsafe class AIPDType1EntryNode : ResourceNode
    {
        ...
        public override bool OnInitialize()
        {
            if (_name == null) _name = "0x" + Header->_command.ToString("X");
        ...
        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            var header = (AIPDType1Entry*) address;
    ...
    public unsafe class AIPDType2OffsetsNode : ResourceNode
    {
        ...
        public override void OnPopulate()
        {
            foreach (var ptr in Entries) new AIPDType2Node().Initialize(this, new DataSource(ptr, 0x0));
        }

        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            var Offsets = (bint*) address;
            var offset = Type1EntrySize + Children.Count * 0x4 + 0x1E0;
            var entry = address + offset - 0x1E0;
            var childSize = 0;
        ...
        {
            var size = 0x0;
            foreach (AIPDType2Node n in Children) size += n.CalculateSize(true);
    ...
    public unsafe class AIPDType2Node : ResourceNode
    {
        ...
        public override bool OnInitialize()
        {
            ...
            Entries = Header->Entries;
            if (_name == null) _name = "0x" + ((short) Header->_id).ToString("X");
        ...
        public override void OnPopulate()
        {
            foreach (var ptr in Entries) new AIPDType2EntryNode().Initialize(this, new DataSource(ptr, 0x0));
        }

        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            var header = (AIPDType2*) address;
            header->_flag = flag;
            header->_id = id;
            header->_numEntries = (byte) Entries.Count;
            var entry = (AIPDType2Entry*) (address + 0x4);
        ...
        public override int OnCalculateSize(bool force)
        {
            var size = 0x4; //id and flag, numEntries
    ...
    public unsafe class AIPDType2EntryNode : ResourceNode
    {
        ...
        public override bool OnInitialize()
        {
            if (_name == null) _name = "Type2Entry " + Parent.Children.IndexOf(this);
        ...
        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            var header = (AIPDType2Entry*) address;
            header->_unk1 = unk1;
            header->_unk2 = unk2;
            header->_unk3 = unk3;
            header->_unk4 = unk4;
