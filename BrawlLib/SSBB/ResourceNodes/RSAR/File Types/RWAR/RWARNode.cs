...
namespace BrawlLib.SSBB.ResourceNodes
{
    public unsafe class RWARNode : RSAREntryNode
    {
        ...
        {
            var size = RWAR.Size + (12 + Children.Count * 12).Align(0x20) + RWARDataBlock.Size;
            foreach (RWAVNode n in Children) size += n.WorkingUncompressed.Length;
        ...
        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            ...
            var tabl = (RWARTableBlock*) (address + 0x20);
            ...
            var data = (RWARDataBlock*) (address + 0x20 + tabl->_header._length);
            data->_header._tag = RWARDataBlock.Tag;

            var addr = (VoidPtr) data + 0x20;
