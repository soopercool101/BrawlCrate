...
namespace BrawlLib.SSBB.ResourceNodes
{
    public unsafe class RWSDDataNode : RSARFileEntryNode
    {
        ...
        public override bool OnInitialize()
        {
            ...
            var r = (ruint*) list->Get(_offset, 0);
            var l = (RuintList*) r->Offset(_offset);
            ...
            if (_name == null) _name = string.Format("[{0}]Data", Index);
        ...
        {
            foreach (var n in _refs) n.SoundDataNode = null;
