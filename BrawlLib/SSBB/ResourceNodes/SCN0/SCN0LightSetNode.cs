...
namespace BrawlLib.SSBB.ResourceNodes
{
    public unsafe class SCN0LightSetNode : SCN0EntryNode
    {
        ...
        {
            if (_lights[index] != null) return _lights[index].Name;
        ...
        {
            var node = (SCN0Node) Parent.Parent;
            var g = node.GetFolder<SCN0LightNode>();
            var strings = Data->StringOffsets;
            if (g != null && !_replaced)
                for (var i = 0; i < Data->_numLights && i < 8; i++)
        ...
        internal override void GetStrings(StringTable table)
        {
            ...
            if (_ambient != null && !string.IsNullOrEmpty(_ambient.Name)) table.Add(_ambient.Name);
        ...
        public override void OnRebuild(VoidPtr address, int length, bool force)
        {
            ...
            var header = (SCN0LightSet*) address;
        ...
        protected internal override void PostProcess(VoidPtr scn0Address, VoidPtr dataAddress, StringTable stringTable)
        {
            ...
            var header = (SCN0LightSet*) dataAddress;
            ...
            int i;
            var strings = header->StringOffsets;
            for (i = 0; i < 8; i++)
                if (!string.IsNullOrEmpty(GetLightName(i)))
