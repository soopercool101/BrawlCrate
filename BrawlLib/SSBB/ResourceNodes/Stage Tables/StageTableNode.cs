...
namespace BrawlLib.SSBB.ResourceNodes
{
    public abstract unsafe class StageTableNode : ARCEntryNode, IAttributeList
    {
        ...
        public virtual int NumEntries => entries.Length / EntrySize;
        [Category("Stage Data Table")]
        public virtual int Version { get => version; set { version = value; SignalPropertyChange(); } }
        [Category("Stage Data Table")]
        public virtual int Unknown1 { get => unk1; set { unk1 = value; SignalPropertyChange(); } }
        [Category("Stage Data Table")]
        public virtual int Unknown2 { get => unk2; set { unk2 = value; SignalPropertyChange(); } }

        [Category("Stage Data Table"), Browsable(false)]
        internal virtual int EntryOffset { get => _entryOffset; set { _entryOffset = value; SignalPropertyChange(); } }

        ~StageTableNode() { entries.Dispose(); }
        ...
        protected virtual AttributeInterpretation GenerateDefaultInterpretation()
        {
            ...
            string filename = AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation\\" + DocumentationSubDirectory + "\\" + root.Name.ToUpper().Replace("STG", "") + temp + ".txt";
        ...
        protected virtual void ReadConfig()
        {
            ...
            {
                if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation\\" + DocumentationSubDirectory))
                {
                    foreach (string path in Directory.EnumerateFiles(AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation\\" + DocumentationSubDirectory, "*.txt"))
                    {
