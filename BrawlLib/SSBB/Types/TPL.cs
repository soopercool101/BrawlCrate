...
namespace BrawlLib.SSBBTypes
{
    ...
    internal unsafe struct TPLHeader
    {
        ...
        {
            if (Offsets[index]._textureOffset > 0) return (TPLTextureHeader*) (Address + Offsets[index]._textureOffset);
            return null;
        }

        public TPLPaletteHeader* GetPaletteEntry(int index)
        {
            if (Offsets[index]._paletteOffset > 0) return (TPLPaletteHeader*) (Address + Offsets[index]._paletteOffset);
            return null;
        }
