...
namespace BrawlLib.Modeling
{
    public class Facepoint
    {
        ...
        public ushort NodeID
        {
            get
            {
                if (Node != null) return (ushort) Node.NodeIndex;
        ...
        {
            if (obj == null || !(obj is Facepoint)) return false;
    ...
    public class PrimitiveGroup
    {
        ...
        public void RegroupNodes()
        {
            ...
            for (var i = 0; i < _headers.Count; i++)
                ...
                foreach (var point in _facePoints[i])
        ...
        {
            var grpAddr = (byte*) (primAddr + _offset);
            for (var i = 0; i < _nodeOffsets.Count; i++)
        ...
        public bool TryAdd(PrimitiveClass p)
        {
            ...
            if (p is FPoint) return TryAdd(p as FPoint);
        ...
        private bool TryAdd(PointTriangleStrip t)
        {
            ...
            {
                var id = p.NodeID;
                if (!_nodes.Contains(id) && !newIds.Contains(id)) newIds.Add(id);
            }
