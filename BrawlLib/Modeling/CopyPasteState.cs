...
namespace BrawlLib.Modeling
{
    ...
    public class CopiedLinkPlaneState
    {
        ...
        public void CreateLinksAndPlanes(CollisionObject TargetObject, bool HighlightLinks = true,
                                         bool TakeActualLinkValue = false)
        {
                ...
                if (Link.CollisionPlaneMembers != null && Link.CollisionPlaneMembers.Count > 0)
                {
                    ...
                    for (int pa = 0; pa < Link.CollisionPlaneMembers.Count; ++pa)
                    {
                        ...
                        else
                        {
                            ...
                            leftLink = new CollisionLink(TargetObject,
                                TakeActualLinkValue ? LeftLink_S.Value : LeftLink_S.RawValue);
                        ...
                        {
                            rightLink = new CollisionLink(TargetObject,
                                TakeActualLinkValue ? RightLink_S.Value : RightLink_S.RawValue);
            ...
            {
                CollisionLink_S l = CopiedLinks[li];
