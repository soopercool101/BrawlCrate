...
namespace Gif.Components
{
    public class AnimatedGifEncoder
    {
        ...
        {
            if (fps != 0f) delay = (int) Math.Round(1000f / fps);
        }
        ...
        protected unsafe void AnalyzePixels()
        {
            ...
            if (transparent != Color.Empty) transIndex = FindClosest(transparent);
        }
