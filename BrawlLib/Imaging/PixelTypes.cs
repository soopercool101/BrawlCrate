...
namespace BrawlLib.Imaging
{
    ...
    public unsafe struct HSVPixel
    {
        ...
        public static explicit operator ARGBPixel(HSVPixel pixel)
        {
            ...
            {
                var h = pixel.H / 60 % 6;
                var f = pixel.H / 60.0f - pixel.H / 60;

                var p = (byte) (pixel.V * (100 - pixel.S) * 255 / 10000);
                var q = (byte) (pixel.V * (100 - (int) (f * pixel.S)) * 255 / 10000);
                var t = (byte) (pixel.V * (100 - (int) ((1.0f - f) * pixel.S)) * 255 / 10000);
    ...
    public unsafe struct RGBAPixel : IComparable //, ICustomTypeDescriptor
    {
        ...
        public override bool Equals(object obj)
        {
            if (obj is RGBAPixel) return this == (RGBAPixel) obj;
        ...
        public static RGBAPixel Parse(string s)
        {
            ...
            for (var i = 0; i < 8; i += 2)
                *ptr++ = s.Length >= i + 2
                    ? byte.Parse(s.Substring(i, 2), NumberStyles.HexNumber)
                    : (byte) (i == 6 ? 0xFF : 0);
    ...
    internal struct ColorF4
    {
        ...
        public override bool Equals(object obj)
        {
            if (obj is ColorF4) return this == (ColorF4) obj;
    ...
    public unsafe struct GXColorS10
    {
        ...
        public override bool Equals(object obj)
        {
            if (obj is GXColorS10) return this == (GXColorS10) obj;
