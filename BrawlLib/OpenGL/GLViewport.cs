...
namespace BrawlLib.OpenGL
{
    public class GLViewport
    {
        ...
        public Image BackgroundImage
        {
            ...
            set
            {
                if (_backImg != null) _backImg.Dispose();
        ...
        public void Resize()
        {
            if (_owner != null) Resize(_owner.Width, _owner.Height);
        }
        ...
        {
            var diff = type == ViewportProjection.Orthographic && _type != ViewportProjection.Perspective;
