    ...
    public class BRESWrapper : GenericWrapper
    {
        ...
        static BRESWrapper()
        {
            ...
            _menu.Items.Add(new ToolStripMenuItem("Ne&w", null,
                ...
                new ToolStripMenuItem("Model Animation (CHR)", null, NewChrAction),
                new ToolStripMenuItem("Texture Animation (SRT)", null, NewSrtAction),
                new ToolStripMenuItem("Texture Pattern (PAT)", null, NewPatAction),
                new ToolStripMenuItem("Visibility Sequence (VIS)", null, NewVisAction),
                new ToolStripMenuItem("Vertex Morph (SHP)", null, NewShpAction),
                new ToolStripMenuItem("Color Sequence (CLR)", null, NewClrAction),
                new ToolStripMenuItem("Scene Settings (SCN)", null, NewScnAction)
            ));
            _menu.Items.Add(new ToolStripMenuItem("&Import", null,
                ...
                new ToolStripMenuItem("Texture Patterns (PAT)", null, ImportPatAction),
                new ToolStripMenuItem("Visibility Sequences (VIS)", null, ImportVisAction),
                new ToolStripMenuItem("Vertex Morphs (SHP)", null, ImportShpAction),
                new ToolStripMenuItem("Color Sequences (CLR)", null, ImportClrAction),
                new ToolStripMenuItem("Scene Settings (SCN)", null, ImportScnAction),
        ...
        public void ReplaceAll()
        {
            ...
            ExportAllFormatDialog dialog = new ExportAllFormatDialog("Replace All", typeof(TEX0Node), FileFilters.TEX0);
