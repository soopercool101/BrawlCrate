...
namespace BrawlCrate.NodeWrappers
{
    ...
    class TyDataListWrapper : GenericWrapper
    {
        ...
        static TyDataListWrapper()
        {
            _menu = new ContextMenuStrip();

            _menu = new ContextMenuStrip();
            _menu.Items.Add(new ToolStripMenuItem("Set Internal Names to BRRES Names", null, StandardizeNamingAction));
        ...
        protected static void StandardizeNamingAction(object sender, EventArgs e)
        {
            GetInstance<TyDataListWrapper>().StandardizeNaming();
        }
        ...
        {
            TyDataListWrapper w = GetInstance<TyDataListWrapper>();
        ...
        public void StandardizeNaming()
        {
            if (Resource.HasChildren)
            {
                foreach (TyDataListEntryNode n in Resource.Children)
                {
                    if (!n.BRRES.Equals(n.Name))
                    {
                        n.Name = n.BRRES;
                    }
                }
    ...
    class TyDataListEntryWrapper : GenericWrapper
    {
        ...
        {
            GetInstance<TyDataListEntryWrapper>().OpenBRRES();
        }
