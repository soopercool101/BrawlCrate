...
namespace BrawlCrate.NodeWrappers
{
    ...
    public class MDL0Wrapper : GenericWrapper
    {
        ...
        public void ReimportMeshes()
        {
            ...
            {
                var replacement = MDL0Node.FromFile(ofd.FileName);
                if (replacement != null)
                {
        ...
        {
            var model = (MDL0Node) _resource;

            if (model._shadGroup == null)
            {
                var g = model._shadGroup;
                if (g == null)
                {
                ...
                model._shadList.Count < model._matList.Count)
            {
                ...
                var b = FindResource(shader, true);
        ...
        public void NewMaterial()
        {
            ...
            if (model._shadList.Count == 0) NewShader();
        ...
        public void AutoMetal()
        {
            if (MessageBox.Show(null,
                    ...
                    "", MessageBoxButtons.YesNo) == DialogResult.Yes) ((MDL0Node) _resource).GenerateMetalMaterials();
        }

        public void NameVertex()
        {
            var model = (MDL0Node) _resource;
            var g = model._vertGroup;
            if (g != null)
                foreach (MDL0VertexNode v in g.Children)
                {
                    var name = model.Name + "_";
        ...
        public MDL0VertexNode NewVertex()
        {
            ...
            var node = new MDL0VertexNode {Name = "VertexSet" + ((MDL0Node) _resource)._vertList.Count};
        ...
        public MDL0NormalNode NewNormal()
        {
            ...
            var node = new MDL0NormalNode {Name = "NormalSet" + ((MDL0Node) _resource)._normList.Count};
        ...
        public MDL0ColorNode NewColor()
        {
            ...
            var node = new MDL0ColorNode {Name = "ColorSet" + ((MDL0Node) _resource)._colorList.Count};
        ...
        public MDL0UVNode NewUV()
        {
            ...
            var node = new MDL0UVNode {Name = "#" + ((MDL0Node) _resource)._uvList.Count};
        ...
        public void ImportVertex()
        {
            ...
            if (o.ShowDialog() == DialogResult.OK) NewVertex().Replace(o.FileName);
        }
        ...
        public void ImportNormal()
        {
            ...
            if (o.ShowDialog() == DialogResult.OK) NewNormal().Replace(o.FileName);
        }
        ...
        public void ImportColor()
        {
            ...
            if (o.ShowDialog() == DialogResult.OK) NewColor().Replace(o.FileName);
        }
        ...
        public void ImportUV()
        {
            ...
            if (o.ShowDialog() == DialogResult.OK) NewUV().Replace(o.FileName);
        }
        ...
        {
            var model = _resource as MDL0Node;
            if (model != null) model.CalculateBoundingBoxes();
        }
