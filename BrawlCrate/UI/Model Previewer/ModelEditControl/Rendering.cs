...
namespace System.Windows.Forms
{
    public partial class ModelEditControl : ModelEditorBase
    {
        ...
        public void RenderBrawlStageData(ModelPanelViewport panel)
        {
            ...
            var ItemBones = new List<MDL0BoneNode>();
            ...
            if (stgPos != null)
                foreach (var bone in stgPos._linker.BoneCache)
                    ...
                    {
                        var position = bone._frameMatrix.GetPoint();
            ...
            if (ItemBones != null && chkItems.Checked)
            {
                ...
                for (var i = 0; i < ItemBones.Count; i += 2)
                {
                    var pos1 = new Vector3(ItemBones[i]._frameMatrix.GetPoint()._x,
                        ItemBones[i]._frameMatrix.GetPoint()._y + 3.0f, 1.0f);
                    var pos2 = new Vector3(ItemBones[i + 1]._frameMatrix.GetPoint()._x,
